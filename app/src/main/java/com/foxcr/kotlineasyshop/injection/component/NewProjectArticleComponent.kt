...
//import com.foxcr.kotlineasyshop.ui.fragment.NewProjectArticleFragment
//import dagger.Component
//
//
//@PerActivityScope
//@Component(modules = [HomeModule::class],dependencies = [ActivityComponent::class])
//interface NewProjectArticleComponent {
//    fun inject(fragment:NewProjectArticleFragment)
//}